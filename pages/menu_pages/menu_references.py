...
class MenuReferences(BasePage):
    ...
    def __init__(self, driver: WebDriver):
        ...
        self.glossary_locator = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Glossary"]')
        self.liner_terms_locator = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Liner terms"]')
        self.services_and_fee_locator = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Services & fees"]')
        self.alpha_scac_codes_locator =(By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Alpha (SCAC) codes"]')
        self.package_type_locator = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Package types"]')
        self.hs_codes_locator = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="HS Codes"]')
        self.container_dimensions_locator = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Container dimensions"]')
        self.palet_dimensions_locator = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Pallet dimensions"]')
        self.uld_container_type = (By.XPATH, '//div[@class="dropMenu__content drop-references__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="ULD container types"]')
