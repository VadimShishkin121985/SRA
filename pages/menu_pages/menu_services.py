...
class MenuServices(BasePage):
    ...
    def __init__(self, driver: WebDriver):
        ...
        self.importer_page_locator = (By.XPATH,'//div[@class="dropMenu__content js-drop-content"]//a[@class="dropMenu__link dropMenu__link_bold dropMenu__link_width-270"]//i[@class="dropMenu__icon far fa-user"]')
        self.fcl_shipping_services_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="FCL shipping"]')
        self.lcl_shipping_services_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="LCL shipping"]')
        self.bulk_shipping_services_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Bulk & break bulk"]')
        self.dangerous_cargoes_services_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Dangerous cargoes"]')
        self.insurance_services_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Insurance"]')
        self.inspection_services_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Inspection services"]')
        self.certification_service_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Certification"]')
        self.project_cargo_service_page_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Project cargo"]')
        ...
        self.survey_cervices_locator = (By.XPATH, '//div[@class="dropMenu__content js-drop-content"]//span[@class="dropMenu__text"][normalize-space()="Survey services"]')
